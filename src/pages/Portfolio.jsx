  ...
  return (
    <div className="space-y-section-gap">
      ...
      <section className="bg-charcoal/30 border border-glass p-8 md:p-12 rounded-xl text-center space-y-6 max-w-4xl mx-auto">
        ...
        <Link to="/work" className="inline-block border border-momentum-gold text-momentum-gold px-6 py-3 rounded font-label-md hover:bg-momentum-gold/10 transition-colors">
            Work with Us
        </Link>
      </section>
    </div>
