...
export default function Layout() {
  return (
    <div className="dark">
      <div className="bg-obsidian text-on-surface font-body-md min-h-screen flex flex-col">
        {/* TopNavBar */}
        <nav className="bg-surface/80 backdrop-blur-lg fixed top-0 w-full z-50 border-b border-glass transition-all duration-300">
          <div className="flex justify-between items-center h-24 px-margin-desktop max-w-container-max mx-auto">
                        <Link to="/" className="cursor-pointer active:opacity-80 transition-opacity duration-300">
        ...
        {/* Content Canvas */}
        <main className="pt-32 pb-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full flex-grow">
          <Outlet />
        </main>

        {/* Footer */}
                <footer className="bg-obsidian w-full border-t border-glass flat no shadows mt-auto relative">
